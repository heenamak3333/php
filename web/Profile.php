...
<section class="wthree-row py-5">
	<div class="container py-md-5 py-3">
		<h3 class="heading text-capitalize text-center">Your Profile</h3>
		<h5 class="heading mb-5 text-center">Profile</h5>
		<div class="row text-center">
			<div class="col-lg-4 offset-lg-4 team-grids">
				<div class="team-effect">
				<img src="upload/user/<?php echo $fetch->file?>" alt="img" width="100%" height="300px">
				</div>
				<!-- team text -->
